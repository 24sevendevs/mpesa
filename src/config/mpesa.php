...
return [
    ...
    'sandbox' => [
        ...
        'b2c_shortcode' => env('MPESA_SANDBOX_B2C_SHORTCODE', '601322'),
        ...
        'initiator_name' => env('MPESA_SANDBOX_INITIATOR_NAME', 'apitest322'),
        'initiator_password' => env('MPESA_SANDBOX_INITIATOR_PASSWORD', '322reset')
    ],
    'live' => [
